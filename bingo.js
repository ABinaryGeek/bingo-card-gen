...
var author$project$Bingo$Card$init = {
	layout: {free: true, size: 5},
	name: 'Bingo Card',
	values: _List_Nil
};
...
var author$project$Bingo$Card$couldAdd = F2(
	function (value, card) {
		if (elm$core$String$isEmpty(value)) {
			return false;
		} else {
			var _n0 = A2(elm$core$List$member, value, card.values);
			if (_n0) {
				return false;
			} else {
				return true;
...
var author$project$Bingo$Card$setValues = F2(
	function (values, card) {
		return _Utils_update(
			card,
			{values: values});
	});
var author$project$Bingo$Card$add = F2(
	function (value, card) {
		var toAdd = A2(author$project$Bingo$Card$couldAdd, value, card) ? _List_fromArray(
			[value]) : _List_Nil;
		return A2(
			author$project$Bingo$Card$setValues,
			_Utils_ap(card.values, toAdd),
			card);
	});
var author$project$Bingo$Card$changeName = F2(
	function (name, card) {
		return _Utils_update(
			card,
			{name: name});
...
var author$project$Bingo$Card$remove = F2(
	function (value, card) {
		return A2(
			author$project$Bingo$Card$setValues,
			A2(
...
var author$project$Bingo$Utils$bounded = F3(
	function (minimum, maximum, value) {
		return A2(
			elm$core$Basics$min,
			maximum,
			A2(elm$core$Basics$max, minimum, value));
	});
var author$project$Bingo$Card$Layout$resize = F2(
	function (size, layout) {
		return _Utils_update(
			layout,
			{
				size: A3(author$project$Bingo$Utils$bounded, 1, 10, size)
			});
	});
var author$project$Bingo$Card$resize = F2(
	function (size, card) {
		return _Utils_update(
			card,
			{
				layout: A2(author$project$Bingo$Card$Layout$resize, size, card.layout)
			});
	});
...
var author$project$Bingo$Utils$swap = F3(
	function (_this, that, values) {
		return A2(
			elm$core$List$map,
			function (value) {
				return _Utils_eq(value, _this) ? that : (_Utils_eq(value, that) ? _this : value);
			},
			values);
	});
var author$project$Bingo$Card$swap = F3(
	function (_this, that, card) {
		return _Utils_update(
			card,
			{
				values: A3(author$project$Bingo$Utils$swap, _this, that, card.values)
			});
	});
var elm$core$Basics$not = _Basics_not;
var author$project$Bingo$Card$Layout$toggleFreeSquare = function (layout) {
	return _Utils_update(
		layout,
		{free: !layout.free});
};
var author$project$Bingo$Card$toggleFreeSquare = function (card) {
	return _Utils_update(
		card,
		{
...
var norpan$elm_html5_drag_drop$Html5$DragDrop$DraggedOver = F3(
	function (a, b, c) {
		return {$: 'DraggedOver', a: a, b: b, c: c};
	});
				...
				case 'DragEnter':
					switch (_n0.b.$) {
						case 'Dragging':
							...
							var dragId = _n0.b.a;
							return _Utils_Tuple2(
								A3(norpan$elm_html5_drag_drop$Html5$DragDrop$DraggedOver, dragId, dropId, elm$core$Maybe$Nothing),
								elm$core$Maybe$Nothing);
						case 'DraggedOver':
							var dropId = _n0.a.a;
							var _n2 = _n0.b;
							...
							var pos = _n2.c;
							return _Utils_Tuple2(
								A3(norpan$elm_html5_drag_drop$Html5$DragDrop$DraggedOver, dragId, dropId, pos),
								elm$core$Maybe$Nothing);
						default:
							break _n0$9;
					}
				...
				case 'DragOver':
					switch (_n0.b.$) {
						...
						case 'DraggedOver':
							...
							var _n6 = _n0.b;
							var dragId = _n6.a;
							var currentDropId = _n6.b;
							var currentPos = _n6.c;
							return (_Utils_eq(
								elm$core$Maybe$Just(pos),
...
var author$project$Bingo$Editor$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AddNewValue':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							card: A2(author$project$Bingo$Card$add, model.newValueInput, model.card),
							newValueInput: ''
						}),
					A2(
			...
			case 'ChangeName':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							card: A2(author$project$Bingo$Card$changeName, name, model.card)
						}),
					elm$core$Platform$Cmd$none);
			case 'Resize':
				var sizeString = msg.a;
				var card = function () {
					var _n2 = elm$core$String$toInt(sizeString);
					if (_n2.$ === 'Just') {
						var size = _n2.a;
						return A2(author$project$Bingo$Card$resize, size, model.card);
					} else {
						return model.card;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						...
						{card: card}),
					elm$core$Platform$Cmd$none);
			case 'ToggleFreeSquare':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							card: author$project$Bingo$Card$toggleFreeSquare(model.card)
						}),
					elm$core$Platform$Cmd$none);
			case 'Randomise':
			...
			case 'Reorder':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							card: A2(author$project$Bingo$Card$setValues, values, model.card)
						}),
					elm$core$Platform$Cmd$none);
			case 'DragDropMsg':
				...
				var card = function () {
					if (result.$ === 'Just') {
						...
						if (dropTarget.$ === 'ValueTarget') {
							...
							return A2(author$project$Bingo$Card$remove, dragged, model.card);
						}
					} else {
						return model.card;
					}
				...
				if (_n4.$ === 'E') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$V(newViewer)
							}),
...
var author$project$Bingo$Card$squareText = function (sq) {
	switch (sq.$) {
		case 'Filled':
			var value = sq.a;
			return value;
...
var author$project$Bingo$Card$square = F2(
	function (attributes, sq) {
		return A2(
			elm$html$Html$li,
			_Utils_ap(
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('bingo-square')
					]),
				A2(author$project$Bingo$Card$squareMap, attributes, sq)),
			_List_fromArray(
				[
					A2(
					elm$html$Html$span,
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							author$project$Bingo$Card$squareText(sq))
						]))
				]));
	});
...
var author$project$Bingo$Card$squares = F2(
	function (layout, values) {
		var amount = author$project$Bingo$Card$Layout$amountOfSquares(layout);
		var _n0 = A2(author$project$Bingo$Utils$split, amount, values);
		var used = _n0.a;
		var unused = _n0.b;
		var actualAmount = elm$core$List$length(used);
		var extraNeeded = amount - actualAmount;
		var padded = _Utils_ap(
			A2(elm$core$List$map, author$project$Bingo$Card$Model$Filled, used),
			A2(elm$core$List$repeat, extraNeeded, author$project$Bingo$Card$Model$Unfilled));
		var _n1 = author$project$Bingo$Card$Layout$freeSquareUsed(layout);
		if (_n1) {
			var half = (amount / 2) | 0;
			return elm$core$List$concat(
				_List_fromArray(
					[
						A2(elm$core$List$take, half, padded),
						_List_fromArray(
						[author$project$Bingo$Card$Model$Free]),
						A2(elm$core$List$drop, half, padded)
					]));
		} else {
			return padded;
		}
...
var author$project$Bingo$Card$Layout$gridStyles = function (layout) {
	var size = elm$core$String$fromInt(layout.size);
	var template = 'repeat(' + (size + ', 1fr)');
	return _List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'grid-template-columns', template),
			A2(elm$html$Html$Attributes$style, 'grid-template-rows', template)
		]);
};
var elm$html$Html$ul = _VirtualDom_node('ul');
var author$project$Bingo$Card$grid = F3(
	function (squareAttributes, layout, values) {
		return A2(
			elm$html$Html$ul,
			_Utils_ap(
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('bingo-squares')
					]),
				author$project$Bingo$Card$Layout$gridStyles(layout)),
			A2(
				elm$core$List$map,
				author$project$Bingo$Card$square(squareAttributes),
				A2(author$project$Bingo$Card$squares, layout, values)));
	});
...
var author$project$Bingo$Card$view = F2(
	function (squareAttributes, card) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('bingo-card')
				]),
			_List_fromArray(
				[
					A2(
					...
					A3(author$project$Bingo$Card$grid, squareAttributes, card.layout, card.values),
					A2(
					elm$html$Html$span,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('http://connieswap.tumblr.com/')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('connieswap.tumblr.com')
								]))
						]))
				]));
	});
var author$project$Bingo$Editor$Messages$ChangeName = function (a) {
...
var author$project$Bingo$Editor$changeNameControl = function (name) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('change-name pure-control-group')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$for('name-field')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('name-field'),
						elm$html$Html$Attributes$value(name),
						elm$html$Html$Events$onInput(author$project$Bingo$Editor$Messages$ChangeName)
					]),
				_List_Nil)
			]));
};
var author$project$Bingo$Editor$Messages$Resize = function (a) {
	return {$: 'Resize', a: a};
};
var elm$html$Html$Attributes$type_ = elm$html$Html$Attributes$stringProperty('type');
var author$project$Bingo$Editor$changeSizeControl = function (layout) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$for('size-field')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('size-field'),
						elm$html$Html$Attributes$type_('number'),
						elm$html$Html$Attributes$value(
						elm$core$String$fromInt(layout.size)),
						elm$html$Html$Events$onInput(author$project$Bingo$Editor$Messages$Resize)
					]),
				_List_Nil),
				A2(
				elm$html$Html$span,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('pure-form-message-inline')
					]),
				A2(
					elm$core$List$map,
					elm$html$Html$text,
					_List_fromArray(
						[
							...
							author$project$Bingo$Card$Layout$amountOfSquares(layout)),
							' Squares)'
						])))
			]));
};
...
var author$project$Bingo$Editor$freeSquareControl = function (layout) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('free-square pure-control-group')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$for('free-square-field')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(' Free Square: ')
					])),
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('free-square-field'),
						elm$html$Html$Attributes$type_('checkbox'),
						elm$html$Html$Events$onClick(author$project$Bingo$Editor$Messages$ToggleFreeSquare),
						elm$html$Html$Attributes$checked(
						author$project$Bingo$Card$Layout$freeSquareValid(layout) && layout.free),
						elm$html$Html$Attributes$disabled(
						!author$project$Bingo$Card$Layout$freeSquareValid(layout))
					]),
				_List_Nil)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$for('view-field')
					]),
				_List_fromArray(
					[
...
var author$project$Bingo$Editor$drag = function (dragDrop) {
	var _n0 = norpan$elm_html5_drag_drop$Html5$DragDrop$getDragId(dragDrop);
	if (_n0.$ === 'Just') {
		var draggedValue = _n0.a;
		return elm$core$Maybe$Just(
			{
				draggedValue: draggedValue,
				hoveredValue: norpan$elm_html5_drag_drop$Html5$DragDrop$getDropId(dragDrop)
			});
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$Bingo$Editor$Messages$DragDropMsg = function (a) {
...
var norpan$elm_html5_drag_drop$Html5$DragDrop$DragOver = F2(
	function (a, b) {
...
var author$project$Bingo$Editor$dragDropTarget = function (value) {
	return _Utils_ap(
		A2(norpan$elm_html5_drag_drop$Html5$DragDrop$draggable, author$project$Bingo$Editor$Messages$DragDropMsg, value),
		A2(
			norpan$elm_html5_drag_drop$Html5$DragDrop$droppable,
			author$project$Bingo$Editor$Messages$DragDropMsg,
			author$project$Bingo$Editor$Model$ValueTarget(value)));
};
var author$project$Bingo$Editor$highlightedClass = F2(
...
var author$project$Bingo$Editor$squareAttributes = F2(
	function (highlighted, name) {
		return _Utils_ap(
			author$project$Bingo$Editor$dragDropTarget(name),
			A2(author$project$Bingo$Editor$highlightedClass, name, highlighted));
	});
...
var author$project$Bingo$Editor$ValueList$valueListItem = F3(
	function (attributes, used, value) {
		return A2(
			elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								author$project$Bingo$Editor$ValueList$usedClass(used)
							]),
						attributes(value)),
					_List_fromArray(
						[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Bingo$Card$view, attributes, model.card)
					]))
			]));
};
var author$project$Bingo$Viewer$view = function (model) {
		...
		return {
			body: _List_fromArray(
				[
					...
					author$project$Bingo$Editor$view(editor))
				]),
		...
		return {
			body: _List_fromArray(
				[
					...
					author$project$Bingo$Viewer$view(viewer))
				]),
